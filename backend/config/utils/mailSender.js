...
exports.sendResetMail = (email, link) => {
  const html =
    ...
    `">${link}</a><p>This token is only valid for 1 hour.</p>
            <p>If it wasn't you or if you have any questions, please email me at <a href="mailto:hello@nirajshrestha.tech">hello@nirajshrestha.tech</a>.</p><p>Regards,</p><p>Admin at <a href="nirajshrestha.tech">nirajshrestha.tech</a></p>`;
  this.sendMail(email, "Confirm password change", html);
};

exports.sendActivationMail = (email, fullname, role, link) => {
  const html =
    `<h2>Hello, ${fullname}!</h2><h3>My new ${role}!</h3><p>Please click on the following link to activate your account.</p><a href="` +
    link +
